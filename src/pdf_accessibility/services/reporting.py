...
from pdf_accessibility.models.validation import ValidationArtifact, ValidationStatus
...
class EARLReportGenerator:
    ...
    def generate_report(self, validation_artifact: ValidationArtifact) -> str:
        """
        Converts a ValidationArtifact into an EARL JSON-LD report.
        """
        report = {
    ...
    def _map_finding(self, finding: Any) -> dict[str, Any]:
        earl_finding = {
            "@type": "earl:Assertion",
            "test": {
                "@type": "earl:TestCase",
            ...
            "result": {
                "@type": "earl:TestResult",
                "outcome": "earl:failed" if finding.severity == "error" else "earl:warning",
            },
        }
